	...
	<div class="wrap_body">
		<div class="body_content">
			<div class="content_head">
				<div class="left">1: ค้นหาสูตรการผลิต</div>
				<div class="right m_right15">
					<button class="btn_box btn_confirm" onclick="window.location='formular_new.jsp';">สร้างสูตรใหม่</button>
				</div>
				<div class="clear"></div>
			</div>
			...
			<div class="content_body">
				<div class="detail_wrap s900 center">
					<form style="margin: 0; padding: 0;" action="formular_search.jsp" id="search" method="get">
						<table>
							<tr>
								<td>ค้นหาจาก</td>
								<td>: 
				...
				<!-- next page  -->
				<div class="right txt_center m_right20"><%=PageControl.navigator_en(ctrl,"formular_search.jsp",param)%></div>
				<div class="clear"></div>
				<!-- next page  -->
					...
					<tbody>
						...
						%>
							<tr>
								...
								<td align="center">
									<button class="btn_box" onclick="javascript: window.location='formular_view.jsp?mat_code=<%=entity.getMat_code()%>';">ดู/แก้ไข สูตร</button>
								</td>
							</tr>
						<%}
						if(has){%>
