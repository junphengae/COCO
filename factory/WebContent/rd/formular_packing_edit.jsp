...
<form id="material_edit_form" onsubmit="return false;">
	...
	<table width="100%"  class="center" id="tb_material_add" border="0" >
		<tbody>
			...
			<tr>
				<td align="right">จำนวนที่ใช้ :</td>
				<td align="left">
					<input type="text" class="txt_box required" autocomplete="off" id="usage_" name="usage_" title="ระบุจำนวนที่ใช้!" value="<%=detail.getUsage_()%>">
				</td>												
			</tr>
			<tr>
