				...
				<table cellpadding="3" cellspacing="3" border="0" class="center s550">
					<tbody>
						...
						<tr>
							...
							<td align="left">: 
								<input value="<%=(per.getDate_start() == null)?"":WebUtils.DATE_FORMAT_EN.format(per.getDate_start()) %>" type="text" autocomplete="off" name="date_start" id="date_start" class="txt_box s150">
							</td>
						</tr>
