...
$(function(){
	...
	$('#btn_view').click(function(){
			if ($('#type_date').is(':checked')) {
				if ($('#date').val() != '') {
					popup('reportMat2PD.jsp?' + form.serialize());
				} else {
	...
	$('#report_type').change(function(){
		if ($(this).val() == 'reportPD' || $(this).val() == 'reportOutlet') {
			tr_type_time.show();
					...
					<tr>
						...
						<td>: 
							<bmp:ComboBox name="report_type" styleClass="txt_box s250" value="">
								<bmp:option value="reportOutlet" text="รายงานการเบิกสินค้า"></bmp:option>
								<bmp:option value="reportPD" text="รายงานยอดรวมการเบิกวัตถุดิบ"></bmp:option>
							</bmp:ComboBox>
						</td>
					</tr>
