...
List list = LogisSend.searchPrepare(ctrl, paramList);
%>
</head>
<body>
	...
	<div class="wrap_body">
		<div class="body_content">
			<div class="content_head">
				<div class="left">รายการจัดของ</div>
				<div class="clear"></div>
			</div>
			
			<div class="content_body">
					<div class="detail_wrap s800 center txt_center">
						<form style="margin: 0; padding: 0;" action="logis_prepare.jsp" id="search" method="get">
					...
					<!-- next page -->  
					<div class="right txt_center m_right20"><%=PageControl.navigator_en(ctrl,"logis_prepare.jsp",paramList)%></div>
					<div class="clear"></div>
					<!-- next page  -->
					...
					<table class="bg-image s930">
						...
						<%
							...
							if(has){
						%>
							<tr><td colspan="8" align="center">---- ไม่พบรายการจัดส่ง ---- </td></tr>
						<%
							}
						%>
						</tbody>
				...
				<div class="wrap_desc">
				- หน้าจอนี้ใช้แสดงรายการการจัดส่ง ที่ store เบิกของมาไว้แล้ว
				</div>
		</div>
	</div>
