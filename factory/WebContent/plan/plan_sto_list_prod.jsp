...
Iterator ite = Production.selectByStatusPacked(ctrl, paramList).iterator();
%>
...
function(){
	...
	$(".btn_select").click(function () {
			ajax_load();
			$.post('../ProductionServlet',{action:'update_production_to_sto',sto_no:<%=sto_no%>,pro_id:$(this).attr("pro_id"),update_by:$("#update_by").val()}, function(resData){
				ajax_remove();
			...
			<div class="content_body">
					<div class="detail_wrap s600 left">
						<form style="margin: 0; padding: 0;" action="plan_staging_list_prod.jsp" id="search" method="get">
							<input type="hidden" class="txt_box" name="stg_no" id="stg_no" value="<%=sto_no%>">
