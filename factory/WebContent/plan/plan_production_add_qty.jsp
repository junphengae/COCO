	...
	<div class="wrap_body">
		<div class="body_content">
			<div class="content_head">
				<div class="left">สร้างรายการโปรดักชั่น :  <%=master.getDescription()%></div>
						...
						<tbody>
							<tr>
								...
								<tr>
									...
									<td>: <input type="text" class="txt_box" id="production-create-qty" name="item_qty" value="1"></td>
								</tr>
								...
								<td colspan="2" align="center" height="30">
									<div class="txt_center">
										<input type="button" name="edit" class="btn_box btn_confirm" value="บันทึก" id="btn-confirm"  onclick="createNewProduction()" >
