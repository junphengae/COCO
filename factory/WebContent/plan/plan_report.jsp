...
$(function(){
	...
	$('#report_type').change(function(){
		if (($(this).val() == 'report_mt') || ($(this).val() == 'report_pk') || ($(this).val() == 'report_fg')) {
			tr_type_time.show();
					...
					<tr>
						...
						<td>: 
							<bmp:ComboBox name="report_type" styleClass="txt_box s250" value="">
								...
								<bmp:option value="report_fg" text="รายงานการผลิตสินค้า"></bmp:option>
								<bmp:option value="report_mt" text="รายงานการใช้วัตถุดิบ"></bmp:option>
								<bmp:option value="report_pk" text="รายงานการใช้บรรจุภัณฑ์"></bmp:option>
								<bmp:option value="report_reciv" text="รายงานสินค้าที่ลูกค้าคืน"></bmp:option>
								<bmp:option value="report_noplan" text="รายงานการผลิตที่ไม่ได้ตามแผน"></bmp:option>
								<bmp:option value="report_sale" text="รายงานการขาย"></bmp:option>
								<bmp:option value="report4acount" text="รายงานการขายตาม Invoice"></bmp:option>
								<bmp:option value="report_pd" text="รายงานโปรดักชั่น"></bmp:option>
							</bmp:ComboBox>
						</td>
					</tr>
