...
<form id="comfirm_add_form" onsubmit="return false;">
	...
	<div class="clear"></div>
	<div class="left s80 m_left40">สินค้าที่ต้องการ </div><div class="left s200">: <%=Money.money(item.getItem_qty()) + " " + mat.getDes_unit()%></div>
	<div class="clear"></div>
	<div class="left s80 m_left40">จำนวนบรรจุภัณฑ์ </div><div class="left s200">: <input type="text" class="txt_box required" autocomplete="off" title="ระบุจำนวนบรรจุภัณฑ์!" name="take" id="take"> ใบ
	</div>
	<div class="clear"></div>
			...
			$('#comfirm_add_form').submit(function(){
					...
					$.post('../sale/SaleManage',$(this).serialize(),function(resData){
						...
						if (resData.status == 'success') {		
								...
								window.location = 'plan_sale_ap.jsp';
						} else {
	...
	<div class="txt_center m_top20">
		...
		<input type="hidden" name="item_qty2" id="item_qty2" value="<%=item.getItem_qty()%>">
