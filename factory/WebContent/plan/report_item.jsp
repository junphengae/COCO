...
<div class="wrap_print">
	<div style="margin-top: 80px;"></div>
				...
				%>		
						...
						<% if(product.getStatus().equalsIgnoreCase(Production.STATUS_FINNISH) || product.getStatus().equalsIgnoreCase(Production.STATUS_NO_PRODUCE)){ %>
						<div class="left s200">จำนวนที่ต้องเบิกทั้งหมด </div><div class="left">: <%=Money.money(product.getItem_qty()) + " " + (product.getStatus().equalsIgnoreCase(Production.STATUS_NO_PRODUCE)?mat.getStd_unit():mat.getDes_unit())%></div>
						<div class="clear"></div>
						<%}else{ %>
