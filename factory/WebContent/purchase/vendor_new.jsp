	...
	<div class="wrap_body">
		<div class="body_content">
			<div class="content_head">
				<div class="left">ทะเบียนผู้ขาย|เพิ่มตัวแทนจำหน่าย</div>
				<div class="clear"></div>
			</div>
			
			<div class="content_body">
			
			<form id="vendor_form" onsubmit="return false;" style="margin: 0;padding: 0;">
				<table cellpadding="3" cellspacing="3" border="0" class="center s550">
					<tbody>
						<tr>
							<td align="left" width="25%"><label>รหัสตัวแทนจำหน่าย</label></td>
							<td align="left" width="75%">: <input type="text" autocomplete="off" name="vendor_code" id="vendor_code" maxlength="10" class="txt_box s150 input_focus required"></td>
						</tr>
						<tr>
