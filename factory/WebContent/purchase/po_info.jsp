		...
		<div class="body_content">
			...
			<div class="content_body">
					<form id="issue_po_form" onsubmit="return false;">
						...
						<div class="m_top5 center">
							...
							<table class="bg-image s930">
								...
								%>
									...
									<tr>
										<td colspan="5" align="right">ส่วนลด (Discount) <%=PO.getDiscount()%> %</td>
									...
									<tr>
										<td colspan="5" align="right">ภาษีมูลค่าเพิ่ม (VAT) <%=PO.getVat()%> %</td>
						...
						<div class="txt_center center m_top5 txt_red txt_bold">ปิดใบสั่งซื้อแล้ว </div>
						<%} else { Personal p_up = Personal.select(PO.getUpdate_by());%>
						<div class="txt_center center m_top5 txt_red txt_bold">ยกเลิกใบสั่งซื้อโดย <%=p_up.getName() + " " + p_up.getSurname()%></div>
						<%}%>
					</form>
