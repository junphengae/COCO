		...
		<div class="body_content">
			<div class="content_head">
				...
				<div class="right m_right10">
					<button class="btn_box" onclick="window.location='SearchInventory?action=search_after_edit';">ย้อนกลับ</button>
				</div>
				<div class="clear"></div>
			</div>
				...
				<fieldset class="s450 left fset">
					...
					<table width="100%">
						<tbody>
							...
							<tr>
								<td>Min</td>
								<td>: <%=invMaster.getMin()%></td>
							</tr>
							<tr>
								<td>Max</td>
								<td>: <%=invMaster.getMax()%></td>
							</tr>
							<tr>
								<td>จำนวนต่ำสุดที่ต้องสั่งเพิ่ม(MOR)</td>
								<td>: <%=invMaster.getMor()%></td>
							</tr>
							<tr>
								<td>Lead time</td>
								<td>: <%=invMaster.getLeadtime()%></td>
							</tr>
							<tr>
								<td>BBF</td>
								<td>: <%=invMaster.getBbf()%></td>
							</tr>
						</tbody>
					</table>
					...
					<table class="bg-image s900">
						<thead>
							<tr>
								...
								<button type="button" class="btn_box" id="lot_old" onclick="javascript: window.open('lot_old_view.jsp?mat_code=<%=invMaster.getMat_code()%>','barcode','location=0,toolbar=0,menubar=0,width=910,height=500');">Lot. เก่า </button>
								</th>
							</tr>
						</thead>
						<tbody>
						...
						String up = "0";
						Double total = 0.0;
						Iterator iteLot = InventoryLot.selectActiveList(mat_code ,"F").iterator();
