	...
	<div class="wrap_body">
		<div class="body_content">
			...
			<div class="content_body">
				...
				<fieldset class="fset s850 center">
					...
					<div class="s200 right  pointer" onclick="javascript: window.open('print_identity_tag.jsp?mat_code=<%=master.getMat_code()%>&lot_no=<%=LOT.getLot_no()%>','barcode','location=0,toolbar=0,menubar=0,width=1200,height=900');"">
						<img src="../images/btn_ident_tag.png">
					</div>
				...
				<table class="bg-image s900">
					<thead>
						<tr>
							<th valign="top" align="center" width="25%">Lot เลขที่ </th>
							<th valign="top" align="center" width="25%">เลขที่ใบสั่งผลิต</th>
				...
				<div class="s400 center txt_center m_top5">
					<button class="btn_box" onclick="window.location='SearchInventory?action=search_after_edit';">กลับไปหน้าค้นหา</button>
				</div>
			</div>
		</div>
	</div>
