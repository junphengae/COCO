	...
	<div class="wrap_body">
		<div class="body_content">
			...
			<div class="content_body">
				...
				<div class="right txt_center"><%=PageControl.navigator_en(ctrl,"inv_info.jsp")%></div>
				<div class="clear"></div>
				...
				<table class="bg-image  s_auto breakword"><!-- เพิมbreakword มาเพื่อตัดคำ -->
					<thead>
						<tr>
							...
							<th valign="top" align="center" width="14%">Check Date</th>
								...
								<table class="bg-image"  style="border-collapse: collapse;" width="100%">
									<%
										...
										while(ite.hasNext()) {
											...
											has = true;
											/* String time = String.valueOf(entity.getApprove_date());
											String time_sub ="";
											if(entity.getApprove_date() == null){
												time_sub = "";
											}else{
												time_sub = time.substring(10, 19);
											} */
									%>
										<tr>
