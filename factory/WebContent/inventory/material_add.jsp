				...
				<form id="material_form" onsubmit="return false">
					<table width="100%">
						<tbody>
							...
							<tr>
								<td>รหัสสินค้า **</td>
								<td>: <input type="text" autocomplete="off" name="mat_code" id="mat_code" class="txt_box s300 required" title="ระบุรหัสสินค้า!" maxlength="20"></td>
							</tr>
							<tr>
								<td>รหัสเดิม</td>
							...
							<tr>
								<td>Min</td>
								<td>: <input type="text" autocomplete="off" name="min" class="txt_box" ></td>
							</tr>
							<tr>
								<td>Max</td>
								<td>: <input type="text" autocomplete="off" name="max" class="txt_box" ></td>
							</tr>
							<tr>
							...
							<tr>
								<td>Lead time</td>
								<td>: <input type="text" autocomplete="off" name="leadtime" class="txt_box" ></td>
							</tr>
							<tr>
								<td>BBF</td>
								<td>: <input type="text" autocomplete="off" name="bbf" class="txt_box" ></td>
							</tr>
							<tr>
