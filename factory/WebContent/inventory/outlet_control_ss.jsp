		...
		<div class="body_content">
			...
			<div class="content_body">
					...
					<table width="100%" id="tb_input" class="hide">
						<tbody>
							<tr>
								...
								<td width="70%">: <span id="lot_balance"></span> KG</td>
							</tr>
							<tr><td colspan="2" height="20"></td></tr>
							<tr>
								<td>จำนวนที่เบิก</td>
								<td>: <input type="text" autocomplete="off" name="request_qty" id="request_qty" class="txt_box s200"> KG</td>
							</tr>
							<tr>
								<td>ผู้เบิกสินค้า</td>
								<td>: 
							...
							<tr>
								<td colspan="2" align="center">
									...
									<input type="hidden" name="request_no" value="<%=pro_id%>">
				...
				<fieldset class="s900 fset">
					...
					%>
							<tr>
								<td colspan="5" align="right" class="txt_bold">ยอดที่สามารถเบิกได้: <%=Money.money(total)%> <%=invMaster.getStd_unit()%></td>
							</tr>
						</tbody>
					</table>
				</fieldset>
