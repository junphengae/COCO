		...
		<div class="body_content">
			...
			<div class="content_body">
				<div class="detail_wrap s900 center">
					<form style="margin: 0; padding: 0;" action="approve_package.jsp" id="search" method="get">
						<table class="center">
							<tr>
				...
				<!-- next page -->  
				<div class="right txt_center m_right20"><%=PageControl.navigator_en(ctrl,"approve_package.jsp",param)%></div>
				<div class="clear"></div>
				<!-- next page  -->
				...
				<table class="bg-image s900">
					<thead>
						<tr>
							...
							<th valign="top" align="center" width="18%">ประเภท</th>
							<th valign="top" align="center" width="13%">ราคา</th>
							<th valign="top" align="center" width="14%">สถานะ</th>
							<th width="5%"></th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							...
							<td valign="top" align="center"><button class="btn_box" onclick="window.location='approve_view.jsp?pk_id=<%=pk.getPk_id()%>'">ดู</button></td>
						</tr>
						<%
						}
						%>
