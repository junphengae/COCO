	...
	<div class="wrap_body">
		<div class="body_content">
			<div class="content_body">
				...
				<div class="clear"></div>
					<%
					Iterator itePK = mapOrder.keySet().iterator();
					while (itePK.hasNext()){
						MatTree mat = mapOrder.get((String)itePK.next()) ;
					%>
				...
				<div class="clear"></div>
					<%
					itePK = mapQt.keySet().iterator();
					while (itePK.hasNext()){
						MatTree mat = mapQt.get((String)itePK.next()) ;
					%>
					<div class="left m_left50 s300">- <%=mat.getGroup_id()%></div>
					<div class="left s100"><%=mat.getDescription()%></div>
					<div class="left s100">รายการ</div>
				...
				<div class="clear"></div>
					...
					<% } %>		
				<div class="dot_line m_top10"></div>	
				<div class="left">รายการออก INVOICE</div>
				<div class="clear"></div>
					<%
					itePK = mapINV.keySet().iterator();
					while (itePK.hasNext()){
						MatTree mat = mapINV.get((String)itePK.next()) ;
					%>
					<div class="left m_left50 s300">- <%=mat.getGroup_id()%></div>
					<div class="left s100"><%=mat.getDescription()%></div>
					<div class="left s100">รายการ</div>
					...
					<% } %>			
				<div class="dot_line m_top10"></div>		
				<div class="left">รายการส่งของ</div>
				<div class="clear"></div>
					<%
					itePK = mapSEND.keySet().iterator();
					while (itePK.hasNext()){
						MatTree mat = mapSEND.get((String)itePK.next()) ;
					%>
					<div class="left m_left50 s300">- <%=mat.getGroup_id()%></div>
					<div class="left s100"><%=mat.getDescription()%></div>
					<div class="left s100">รายการ</div>
