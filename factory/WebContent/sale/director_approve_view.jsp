	...
	<div class="wrap_body">
		<div class="body_content">
			<div class="content_head">
				...
				<div class="right btn_box m_right15" onclick="window.location='director_approve.jsp'">ย้อนกลับ</div>
				<div class="clear"></div>
			</div>
			...
			<div class="content_body">
				...
				<div class="detail_wrap s900 center">
					<fieldset class="fset">
						...
						<table class="s900">
							...
							%>
							<tr>
								<td>หมายเหตุ(ผู้บริหารยกเลิก)</td>
								<td>: <%=entity.getRemark()%>
								</td>
							</tr>
							<%
				...
				<table class="bg-image s900">
					...
					<% if(entity.getStatus().equalsIgnoreCase("30")){
					%>
						<button id="Cancel" class="btn_box btn_warn thickbox" lang="director_add_remark.jsp?pk_id=<%=WebUtils.getReqString(request, "pk_id")%>&height=150" title="ยกเลิกรายการนี้">ยกเลิกรายการนี้</button>
					<%
					}else if(entity.getStatus().equalsIgnoreCase("40")){
					%>
						<button id="Direct_ap" class="btn_box btn_confirm" status="<%=Package.STATUS_DIRECTOR_APPROVE%>">ผู้บริหารอนุมัติ</button><%
					}
					else{
					%>
					<button id="Direct_ap" class="btn_box btn_confirm" status="<%=Package.STATUS_DIRECTOR_APPROVE%>">ผู้บริหารอนุมัติ</button>
