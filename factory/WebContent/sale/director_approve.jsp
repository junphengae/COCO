		...
		<div class="body_content">
			...
			<div class="content_body">
				<div class="detail_wrap s900 center">
					<form style="margin: 0; padding: 0;" action="director_approve.jsp" id="search" method="get">
						<table class="center">
							<tr>
								...
								<td>: 
									<bmp:ComboBox name="status" styleClass="txt_box s200" value="<%=status%>">
										<bmp:option value="" text="แสดงทั้งหมด"></bmp:option>
										<bmp:option value="20" text="อนุมัติ"></bmp:option>
										<bmp:option value="30" text="ผู้บริหารอนุมัติ"></bmp:option>
										<bmp:option value="40" text="ผู้บริหารยกเลิก"></bmp:option>
									</bmp:ComboBox>	
								</td>
							</tr>
						</table>
				...
				<!-- next page -->  
				<div class="right txt_center m_right20"><%=PageControl.navigator_en(ctrl,"director_approve.jsp",param)%></div>
				<div class="clear"></div>
				<!-- next page  -->
				...
				<table class="bg-image s900">
					...
					<tbody>
						...
						<tr>
							...
							<td valign="top" align="center"><button class="btn_box" onclick="window.location='director_approve_view.jsp?pk_id=<%=pk.getPk_id()%>'">ดู</button></td>
						</tr>
						<%
						}
						%>
