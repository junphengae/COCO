	...
	<div class="wrap_body">
		<div class="body_content">
			<div class="content_head">
				<div class="left">รายการขาย | แสดงรายชื่อลูกค้า</div>
				<div class="right m_right10">
					<button class="btn_box btn_confirm thickbox" lang="../info/customer_new.jsp?height=450&width=520" title="เพิ่มลูกค้าใหม่">เพิ่มลูกค้าใหม่</button>
				</div>
				<div class="clear"></div>
			</div>
			...
			<div class="content_body">
				<div class="detail_wrap s800 center txt_center">
					<form style="margin: 0; padding: 0;" action="customer_list.jsp" method="get">
				...
				<table class="bg-image s900 m_top5">
					<thead>
						<tr>
							...
							<th width="15%" align="center">ขนส่ง</th>					
