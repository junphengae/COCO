		...
		<div class="body_content">
			...
			<div class="content_body">
				<div class="detail_wrap s900 center">
					<form style="margin: 0; padding: 0;" action="fg_search.jsp" id="search" method="get">
						<table>
							<tr>
								<td>ค้นหาจาก</td>
								<td>: 
				...
				<!-- next page  -->
				<div class="right txt_center m_right20"><%=PageControl.navigator_en(ctrl,"fg_search.jsp",param)%></div>
				<div class="clear"></div>
				<!-- next page  -->
				...
				<table class="bg-image s_auto">
					<thead>
						<tr>
							...
							<th valign="top" align="center" width="14%">รหัสเดิม</th>
					...
					%>
						<tr>
							...
							<td align="center">
								...
								<button class="btn_box btn_select" data_name="<%=entity.getDescription()%>" data_id="<%=entity.getMat_code()%>" data_unit="<%=entity.getDes_unit()%>" data_price="<%=entity.getPrice()%>">เลือก</button>
							</td>
						</tr>
					<%
					}
...
<script type="text/javascript">
	...
	$(function(){
		...
		$(".btn_select").click(function(){ 
		        ...
		        window.opener.$('#unit_price').val($(this).attr('data_price'));
		        window.opener.$('#data_unit').text($(this).attr('data_unit'));
		        window.opener.$('#item_qty2').text($(this).attr('data_price'));  
		       	window.close(); 
		}); 
	});
